package im.zhaojun.zfile.home.install;

import cn.hutool.core.bean.BeanUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.crypto.SecureUtil;
import com.github.xiaoymin.knife4j.annotations.ApiOperationSupport;
import im.zhaojun.zfile.common.exception.InstallSystemException;
import im.zhaojun.zfile.home.model.dto.SystemConfigDTO;
import im.zhaojun.zfile.home.model.request.InstallSystemRequest;
...
public class InstallController {
    ...
    public AjaxJson<Void> install(@RequestBody InstallSystemRequest installSystemRequest) {
        if (StrUtil.isNotEmpty(systemConfigService.getAdminUsername())) {
