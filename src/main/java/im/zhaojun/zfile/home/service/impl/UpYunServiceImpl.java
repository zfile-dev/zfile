...
import im.zhaojun.zfile.admin.model.param.UpYunParam;
import im.zhaojun.zfile.common.exception.NotExistFileException;
import im.zhaojun.zfile.common.exception.UnSupportedOperation;
...
import im.zhaojun.zfile.home.model.upyun.AuthModel;
import im.zhaojun.zfile.home.model.upyun.UploadSignParam;
...
public class UpYunServiceImpl extends AbstractBaseFileService<UpYunParam> {
    ...
    public FileItemResult getFileItem(String pathAndName) {
        try {
            ...
            Map<String, String> fileInfo = upYun.getFileInfo(encodeFullUrl);
    ...
    public boolean newFolder(String path, String name) {
        ...
        try {
            ...
            log.error("存储源 {} 创建文件夹 {} 失败.", storageId, fullPath, e);
        }
        return false;
    }
    ...
    public boolean deleteFile(String path, String name) {
        ...
        try {
            ...
            log.error("存储源 {} 删除文件 {} 异常.", storageId, fullPath, e);
        }
        return false;
    }
    ...
    public boolean renameFolder(String path, String name, String newName) {
        throw new UnSupportedOperation("该存储类型不支持此操作");
    }
    ...
    private String getPolicy(UploadSignParam uploadSignParam) {
        ...
        // params.put(Params.SAVE_KEY, "/{filename}{.suffix}");
