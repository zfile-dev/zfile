...
import im.zhaojun.zfile.common.util.PlaceholderUtils;
...
public abstract class AbstractBaseFileService<P extends IStorageParam> implements BaseFileService {
	...
	public void testConnection() {
		try {
			...
			throw new InitializeStorageSourceException("初始化异常, 错误信息为: " + e.getMessage(), e);
		}
	}
	...
	public void setStorageId(Integer storageId) {
		if (this.storageId != null) {
			throw new RuntimeException("请勿重复初始化存储源");
		}
