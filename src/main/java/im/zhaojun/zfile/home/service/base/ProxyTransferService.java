...
import im.zhaojun.zfile.admin.model.param.ProxyTransferParam;
import im.zhaojun.zfile.admin.service.StorageSourceService;
import im.zhaojun.zfile.admin.service.SystemConfigService;
import im.zhaojun.zfile.common.util.ProxyDownloadUrlUtils;
 ...
 * @author zhaojun
 */
public abstract class ProxyTransferService<P extends ProxyTransferParam> extends AbstractBaseFileService<P>{
