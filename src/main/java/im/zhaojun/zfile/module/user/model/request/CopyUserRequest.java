...
public class CopyUserRequest {
    ...
    @Schema(name = "复制后用户名", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
    @NotBlank(message = "复制后用户名不能为空")
    private String toUsername;

    @Schema(name = "复制后用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
    @NotBlank(message = "复制后用户昵称不能为空")
    private String toNickname;

    @Schema(name = "复制后用户密码", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
